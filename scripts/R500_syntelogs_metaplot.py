...
annotations='../../ref/annotations/R500_syntelogs.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='uncorrected_R500_syntelogs_filtered_allc.tmp'
output='results/uncorrected_R500_syntelogs_metaplot.txt'
