...
annotations='../../ref/annotations/bias/'+sys.argv[1]+'_TO1000_BnCbiased.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='TO1000_BnCbiased_filtered_allc.tmp'
output='results/TO1000_BnCbiased_metaplot.txt'
