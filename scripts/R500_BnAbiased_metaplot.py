...
annotations='../../ref/annotations/bias/'+sys.argv[1]+'_R500_BnAbiased.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='R500_BnAbiased_filtered_allc.tmp'
output='results/R500_BnAbiased_metaplot.txt'
