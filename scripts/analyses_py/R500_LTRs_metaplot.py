...
#define variables
allc='../combined/all_LTRs_filtered_allc.tmp'
annotations='../../ref/annotations/R500_LTRs.gff'
...
first_feature=()
second_feature=()
filtered_data_output='../combined/R500_LTRs_filtered_allc.tmp'
output='../combined/results/R500_LTRs_metaplot.txt'
