...
annotations='../../ref/annotations/bias/'+sys.argv[1]+'_R500_nonbiased.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='R500_nonbiased_filtered_allc.tmp'
output='results/R500_nonbiased_metaplot.txt'
