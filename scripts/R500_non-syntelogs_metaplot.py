...
annotations='../../ref/annotations/R500_non-syntelogs.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='R500_non-syntelogs_filtered_allc.tmp'
output='results/R500_non-syntelogs_metaplot.txt'
