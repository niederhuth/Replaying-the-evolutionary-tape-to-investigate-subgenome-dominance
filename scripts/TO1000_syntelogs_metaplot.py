...
annotations='../../ref/annotations/TO1000_syntelogs.gff'
...
first_feature='gene'
second_feature='CDS'
filtered_data_output='uncorrected_TO1000_syntelogs_filtered_allc.tmp'
output='results/uncorrected_TO1000_syntelogs_metaplot.txt'
